...
class SeqDatasetOHE(Dataset):
    ...
    def __init__(self,
        ...
        self.ohe_seqs = torch.stack([torch.tensor(one_hot_encode(kmer)) for seq in self.seqs for kmer in seq])
        #self.ohe_seqs = torch.stack([torch.tensor(one_hot_encode(seq)) for seq in self.seqs])
...
# ho do you prevent the Ns from swamping it when long reads are relatively rare?
